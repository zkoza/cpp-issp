...
Linux jest jak koń, jaki jest, każdy widzi. Standardowa instalacja programu QtCreator sprowadza się do zainstalowania kilku paczek. To, jaki eto paczki, zależy od dystrybucji Linuksa. W Manjaro Linux w menedżerze pakietów wyszukujemy pakiet qtcreator:
